...
def preprocess_fraud(df):
    ...
    y = df["class"]  # target column is likely named 'class' in your data
    df = pd.get_dummies(df.drop(columns=["user_id", "signup_time", "purchase_time", "device_id", "ip_address", "class"]), drop_first=True)
...
if __name__ == "__main__":
    ...
    plot_pr_curve(xgb_credit, Xc_test, yc_test, "XGBoost - Creditcard")
     ...
     # Precision-Recall Curves for Fraud dataset
